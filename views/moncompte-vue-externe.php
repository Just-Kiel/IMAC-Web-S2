    ...
    <nav class="navbar fixed-top  ">
        ...
        <div class="row d-none d-sm-block">
            <div class="res  align-items-center ">
                <a class="home " href="../accueil" target="blank"><img class="invert" src="../../views/img/accueil.png" alt="Accueil" width="50"></a>
                ...
                <div class="container">
                    ...
                    <div class="text-center">
                        <div class="btn-grp" role="groupe">
                            ...
                            <button class=" modifierbtn  btn btn-secondary" data-toggle="modal" data-target="#exampleModal">ENVOYER UN MESSAGE</button>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class=" fermerbtn btn btn-secondary" data-dismiss="modal">J'ai compris</button>
                                    </div>
                                </div>
                            </div>
                        </div>
